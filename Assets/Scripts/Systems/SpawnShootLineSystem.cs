...
public partial class SpawnShootLineSystem : SystemBase {
    ...
    protected override void OnCreate() {
        ...
        RequireForUpdate(GetEntityQuery(
                ComponentType.ReadOnly<SpawnShootLineRequest>(),
    ...
    protected override void OnUpdate() {
        ...
        Entities
            ...
            .ForEach((Entity rpcEntity, in SpawnShootLineRequest spawnCylinder, in ReceiveRpcCommandRequestComponent requestEntity) => {
